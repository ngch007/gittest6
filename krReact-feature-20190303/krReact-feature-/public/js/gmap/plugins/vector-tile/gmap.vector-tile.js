        ...
        function renderTile(vectorTile) {
          if (vectorTile.layers && vectorTile.layers.length !== 0) {
            for (var layerName in vectorTile.layers) {
              ...
              var layerStyle =
                this.options.vectorTileLayerStyles[layerName] || GMap.Path.prototype.options;
    ...
    resetFeatureStyle: function(id) {
      ...
      for (var tileKey in this._vectorTiles) {
        ...
        if (data) {
          var feat = data.feature;
          var styleOptions =
            this.options.vectorTileLayerStyles[data.layerName] || GMap.Path.prototype.options;
          this._updateStyles(feat, tile, styleOptions);
        }
      }
      return this;
  ...
  GMap.VectorGrid.Protobuf = GMap.VectorGrid.extend({
    ...
    _getVectorTilePromise: function(coords, tileBounds) {
      ...
      if (this._map && !this._map.options.crs.infinite) {
        ...
        if (this.options.tms) {
          // Should this option be available in GMap.VectorGrid?
          data['y'] = invertedY;
        }
        data['-y'] = invertedY;
      }
