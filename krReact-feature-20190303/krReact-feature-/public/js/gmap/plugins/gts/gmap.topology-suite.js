!(function(t, e) {
  ...
  function ce(t) {
    ...
    var e = Number(t[0]),
      ...
      r = Number(t[2]),
      i = Number(t[3]);
    if (6 === t.length) throw new Error('@gts/bbox-polygon does not support BBox with 6 positions');
    var s = [e, n];
  ...
  var fu = function() {
      ...
      return (
        ...
        (t.extent = function(e) {
          return arguments.length
            ? ((r = null == e ? null : [[+e[0][0], +e[0][1]], [+e[1][0], +e[1][1]]]), t)
  ...
  (Yu.prototype.getArea = function() {
    ...
    (Yu.prototype.covers = function() {
      if (1 === arguments.length) {
        ...
        return (
          !this.isNull() &&
          (n >= this._minx && n <= this._maxx && r >= this._miny && r <= this._maxy)
        );
      }
    }),
  ...
  (Uh.prototype.printEdges = function(t) {
    ...
    (Uh.prototype.matchInSameDirection = function(t, e, n, r) {
      return (
        !!t.equals(n) &&
        (sc.computeOrientation(t, e, r) === sc.COLLINEAR && Bh.quadrant(t, e) === Bh.quadrant(n, r))
      );
    }),
        ...
        !!this._li.isProper() ||
          ...
          !!this._li.isProper() ||
            ...
            !!this._li.isProper() ||
              ...
              this._li.computeIntersection(t, e, this._corner[3], this._corner[0]),
              !!this._li.isProper() ||
                (!(!n || !r) || (!!t.equals(this._pt) || !!e.equals(this._pt))))))
      );
    }),
  ...
  (Vp.prototype.filterCoveredNodeToPoint = function(t) {
    ...
    (Vp.prototype.extractNonCoveredResultNodes = function(t) {
      for (
        ...
        if (
          !n.isInResult() &&
          (!n.isIncidentEdgeInResult() && (0 === n.getEdges().getDegree() || t === Cf.INTERSECTION))
        ) {
          var r = n.getLabel();
