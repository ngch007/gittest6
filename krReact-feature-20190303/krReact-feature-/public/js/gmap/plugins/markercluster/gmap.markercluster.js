/*
 GMap.markercluster, Provides Beautiful Animated Marker Clustering functionality for GMap, a JS library for interactive maps.
 https://github.com/GMap/GMap.markercluster
 (c) 2012-2017, Dave Leaver
*/
!(function(e, t, i) {
  (GMap.MarkerClusterGroup = GMap.FeatureGroup.extend({
    options: {
      maxClusterRadius: 80,
      iconCreateFunction: null,
      clusterPane: GMap.Marker.prototype.options.pane,
      spiderfyOnMaxZoom: !0,
    ...
    initialize: function(e) {
      GMap.Util.setOptions(this, e),
        ...
        (this._featureGroup = GMap.featureGroup()),
        this._featureGroup.addEventParent(this),
        (this._nonPointGroup = GMap.featureGroup()),
      ...
      var t = GMap.DomUtil.TRANSITION && this.options.animate;
      GMap.extend(this, t ? this._withAnimation : this._noAnimation),
        (this._markerCluster = t ? GMap.MarkerCluster : GMap.MarkerClusterNonAnimated);
    },
    addLayer: function(e) {
      if (e instanceof GMap.LayerGroup) return this.addLayers([e]);
      if (!e.getLatLng)
    ...
    removeLayer: function(e) {
      return e instanceof GMap.LayerGroup
        ? this.removeLayers([e])
        : e.getLatLng
        ? this._map
          ? e.__parent
    ...
    addLayers: function(e, t) {
      if (!GMap.Util.isArray(e)) return this.addLayer(e);
      var i,
      ...
      if (this._map) {
        var _ = new Date().getTime(),
          d = GMap.bind(function() {
            for (var c = new Date().getTime(); h > l; l++) {
              if (s && 0 === l % 200) {
                var p = new Date().getTime() - c;
                if (p > o) break;
              }
              if (((i = e[l]), i instanceof GMap.LayerGroup))
                u && ((e = e.slice()), (u = !1)), this._extractNonGroupLayers(i, e), (h = e.length);
              else if (i.getLatLng) {
                if (
                  !this.hasLayer(i) &&
    ...
    eachLayer: function(e, t) {
      ...
      for (
        this._topClusterLevel && this._topClusterLevel.getAllChildMarkers(s), n = s.length - 1;
        n >= 0;
        n--
      ) {
    ...
    _removeFromGridUnclustered: function(e, t) {
      for (
        var i = this._map, n = this._gridUnclustered, r = Math.floor(this._map.getMinZoom());
    ...
    _childMarkerDragEnd: function(e) {
      e.target.__dragStart && this._moveChild(e.target, e.target.__dragStart, e.target._latlng),
    ...
    fire: function(e, t, i) {
      if (t && t.layer instanceof GMap.MarkerCluster) {
        if (t.originalEvent && this._isOrIsParent(t.layer._icon, t.originalEvent.relatedTarget))
          return;
        e = 'cluster' + e;
      }
      GMap.FeatureGroup.prototype.fire.call(this, e, t, i);
    },
    listens: function(e, t) {
      return (
        GMap.FeatureGroup.prototype.listens.call(this, e, t) ||
        GMap.FeatureGroup.prototype.listens.call(this, 'cluster' + e, t)
      );
    },
    ...
    _showCoverage: function(e) {
      ...
      this._inZoomAnimation ||
        ...
        e.layer.getChildCount() > 2 &&
          ...
          ((this._shownPolygon = new GMap.Polygon(
    ...
    _generateInitialClusters: function() {
      ...
      for (var r = e; r >= t; r--)
        (this._gridClusters[r] = new GMap.DistanceGrid(n(r))),
          (this._gridUnclustered[r] = new GMap.DistanceGrid(n(r)));
    ...
    _refreshClustersIcons: function() {
      this._featureGroup.eachLayer(function(e) {
        e instanceof GMap.MarkerCluster && e._iconNeedsUpdate && e._updateIcon();
      });
    },
    _enqueue: function(e) {
      this._queue.push(e),
        this._queueTimeout ||
          (this._queueTimeout = setTimeout(GMap.bind(this._processQueue, this), 300));
    },
    ...
    _extractNonGroupLayers: function(e, t) {
      ...
      for (t = t || []; r < n.length; r++)
        (i = n[r]), i instanceof GMap.LayerGroup ? this._extractNonGroupLayers(i, t) : t.push(i);
      return t;
    },
    ...
    GMap.MarkerClusterGroup.include({
      _mapBoundsInfinite: new GMap.LatLngBounds(
        new GMap.LatLng(-1 / 0, -1 / 0),
        new GMap.LatLng(1 / 0, 1 / 0)
      ),
    }),
    GMap.MarkerClusterGroup.include({
      ...
      _withAnimation: {
        _animationStart: function() {
          (this._map._mapPane.className += ' gmap-cluster-anim'), this._inZoomAnimation++;
        },
        _animationZoomIn: function(e, t) {
          var i,
          ...
          (this._ignoreMove = !0),
              ...
              for (
                n.contains(a) || (a = null),
                  s._isSingleParent() && e + 1 === t
                    ? (r.removeLayer(s), s._recursivelyAddChildrenToMap(null, t, n))
                    : (s.clusterHide(), s._recursivelyAddChildrenToMap(a, t, n)),
                  i = h.length - 1;
                i >= 0;
                i--
              )
            ...
            r.eachLayer(function(e) {
              e instanceof GMap.MarkerCluster || !e._icon || e.clusterShow();
            }),
      ...
      _forceLayout: function() {
        GMap.Util.falseFn(t.body.offsetWidth);
      },
    }),
    (GMap.markerClusterGroup = function(e) {
      return new GMap.MarkerClusterGroup(e);
    }),
    (GMap.MarkerCluster = GMap.Marker.extend({
      initialize: function(e, t, i, n) {
        GMap.Marker.prototype.initialize.call(
          this,
          i ? i._cLatLng || i.getLatLng() : new GMap.LatLng(0, 0),
          ...
          (this._bounds = new GMap.LatLngBounds()),
          i && this._addChild(i),
          n && this._addChild(n);
      },
      ...
      _addChild: function(e, t) {
        (this._iconNeedsUpdate = !0),
          ...
          e instanceof GMap.MarkerCluster
        ...
        if (0 !== h) {
          ...
          for (e = 0; e < s.length; e++)
            (t = s[e]),
              ...
              (o += i.lat * n),
              (a += i.lng * n);
          (this._latlng = this._wLatLng = new GMap.LatLng(o / h, a / h)),
            ...
            for (s = e._markers.length - 1; s >= 0; s--)
              (r = e._markers[s]),
                (n && n.contains(r._latlng)) ||
                  (e._group._featureGroup.removeLayer(r), r.clusterShow && r.clusterShow());
          },
          function(e) {
    ...
    (GMap.DistanceGrid = function(e) {
      (this._cellSize = e), (this._sqCellSize = e * e), (this._grid = {}), (this._objectPoint = {});
    }),
    (GMap.DistanceGrid.prototype = {
      ...
      removeObject: function(e, t) {
        var i,
          ...
          a = (o[s] = o[s] || {}),
          h = (a[r] = a[r] || []);
        for (delete this._objectPoint[GMap.Util.stamp(e)], i = 0, n = h.length; n > i; i++)
            ...
            for (i = l - 1; l + 1 >= i; i++)
              if ((s = r[i]))
                for (n = 0, o = s.length; o > n; n++)
                  (a = s[n]),
                    (h = this._sqDist(_[GMap.Util.stamp(a)], e)),
    ...
    GMap.MarkerCluster.include({
      getConvexHull: function() {
        ...
        return GMap.QuickHull.getConvexHull(n);
      },
    }),
    GMap.MarkerCluster.include({
      _2PI: 2 * Math.PI,
      ...
      _generatePointsCircle: function(e, t) {
        ...
        for (s = Math.max(s, 35), a.length = e, i = 0; e > i; i++)
          (n = this._circleStartAngle + i * o),
            (a[i] = new GMap.Point(t.x + s * Math.cos(n), t.y + s * Math.sin(n))._round());
        return a;
      },
      _generatePointsSpiral: function(e, t) {
        ...
        for (h.length = e, i = e; i >= 0; i--)
          e > i && (h[i] = new GMap.Point(t.x + r * Math.cos(a), t.y + r * Math.sin(a))._round()),
            (a += s / r + 5e-4 * i),
            (r += o / a);
        return h;
      },
    ...
    (GMap.MarkerClusterNonAnimated = GMap.MarkerCluster.extend({
      _animationSpiderfy: function(e, t) {
        ...
        for (o._ignoreMove = !0, i = 0; i < e.length; i++)
          (s = a.layerPointToLatLng(t[i])),
            (n = e[i]),
            (r = new GMap.Polyline([this._latlng, s], l)),
            a.addLayer(r),
            (n._spiderLeg = r),
    ...
    GMap.MarkerCluster.include({
      _animationSpiderfy: function(e, t) {
        var n,
          ...
          f = GMap.Path.SVG,
          m = GMap.extend({}, this._group.options.spiderLegPolylineOptions),
          g = m.opacity;
        for (
          g === i &&
            (g = GMap.MarkerClusterGroup.prototype.options.spiderLegPolylineOptions.opacity),
            f
              ? ((m.opacity = 0), (m.className = (m.className || '') + ' gmap-cluster-spider-leg'))
              : (m.opacity = g),
            u._ignoreMove = !0,
            n = 0;
          n < e.length;
    ...
    GMap.MarkerClusterGroup.include({
      ...
      _spiderfierOnAdd: function() {
        this._map.on('click', this._unspiderfyWrapper, this),
          ...
          GMap.Browser.touch || this._map.getRenderer(this);
      },
      ...
      _unspiderfyZoomAnim: function(e) {
        GMap.DomUtil.hasClass(this._map._mapPane, 'gmap-touching') ||
    ...
    GMap.MarkerClusterGroup.include({
      refreshClusters: function(e) {
        return (
          e
            ? e instanceof GMap.MarkerClusterGroup
              ? (e = e._topClusterLevel.getAllChildMarkers())
              : e instanceof GMap.LayerGroup
              ? (e = e._layers)
              : e instanceof GMap.MarkerCluster
              ? (e = e.getAllChildMarkers())
              : e instanceof GMap.Marker && (e = [e])
